...
export KERNEL_TOP=$ANDROID_ROOT/kernel/sony/msm-4.4
export KERNEL_TMP=$ANDROID_ROOT/out/kernel-4.4-clang
...
# Build command
export BUILD="make O=$KERNEL_TMP ARCH=arm64 CC=$CLANG_CC CLANG_TRIPLE=aarch64-linux-gnu CROSS_COMPILE=$CROSS_COMPILE CROSS_COMPILE_ARM32=$CROSS_COMPILE_ARM32 -j$(nproc)"
